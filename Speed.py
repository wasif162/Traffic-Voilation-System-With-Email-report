...
file = ""
layout = [[sg.Text("Choose a Video: "), sg.Input(key='-IMAGE_LOCATION-'), sg.FileBrowse(), sg.Button('Check'), sg.Button('Camera')]]
window = sg.Window('Speed Violation', layout, element_justification='center', finalize=True, resizable=True)
            ...
            if frameCounter % 1 == 0:
                ...
                if [x1, y1, w1, h1] != [x2, y2, w2, h2]:
                    ...
                    if speed[i] != None and y1 >= 180:
                        ...
                        if int(speed[i]) >= 40:
                            lat = "Speed Violation"
                            cv2.imwrite("image1.jpg", resultImage)
                            data = ['1', 'Speed', lat]
                            mail.sendEmail(data)
